...
#USSA VIRMACH
firewall-cmd --permanent --add-forward-port=port=18188:proto={tcp,udp}:toport=18388:toaddr=107.174.240.124 && firewall-cmd -q --reload

#USLA HOSTDARE
firewall-cmd -q --permanent --add-forward-port=port=18588:proto={tcp,udp}:toport=18388:toaddr=185.238.250.78 && firewall-cmd -q --reload
